        ...
        <div>
            ...
            <div style={{ display: "flex", flexDirection: "row" }}>
                <div style={{ display: "flex", flexDirection: "column", margin: 30 }}>
                    <button style={{ margin: 20, fontSize: 48, backgroundColor: "black", border: "none" }} onClick={() => setUserClass('warrior')} type="button" className="btn btn-light"><i style={{ color: "white", fontSize: 240, animationDuration: "4s" }} className="fa-solid fa-khanda fa-shake"></i></button>
