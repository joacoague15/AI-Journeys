...
const AttributesHelp = () => {
    ...
    if (!modalOpened) return (
        <svg onClick={() => setModalOpened(!modalOpened)} style={{ position: "fixed", bottom: 0, right: 0, width: 80, margin: 20, height: 80, backgroundColor: "black", borderRadius: "50%", boxShadow: "0 2px 5px rgba(0,0,0,0.2)", zIndex: 2, cursor: "pointer" }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
