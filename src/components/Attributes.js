        ...
        return (
            <div style={{ margin: 'auto', width: '100%', display: "flex", flexDirection: "column" }}>
                <div style={{ margin: 'auto', paddingTop: 20, width: '100%', display: "flex", flexDirection: "row" }}>
                    ...
                    <div style={{ width: (characterStatuses.health) + "%", backgroundColor: "white" }} className="progress-bar progress-bar-striped progress" role="progressbar"
                ...
                <div style={{ margin: 'auto', paddingTop: 20, width: '100%', display: "flex", flexDirection: "row" }}>
                    ...
                    <div style={{ width: (characterStatuses.mana) + "%", backgroundColor: "white" }} className="progress-bar progress-bar-striped progress" role="progressbar"
                ...
                <div style={{ margin: 'auto',  paddingTop: 20, width: '100%', display: "flex", flexDirection: "row" }}>
                    ...
                    <div style={{ width: (characterStatuses.attack) + "%", backgroundColor: "white" }} className="progress-bar progress-bar-striped progress" role="progressbar"
                          aria-valuemin="0" aria-valuemax="100">
                    </div>
                </div>
            </div>
